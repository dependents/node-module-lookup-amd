...
describe('lookup', () => {
  ...
  describe('when handling deeply nested paths', () => {
    it('expands ... path notation to ../../ for nested subdirectory resolution', () => {
  ...
  describe('when file system errors occur', () => {
    it('throws non-ENOENT errors from fileExists', () => {
      const configObject = new ConfigFile(config).read();
    ...
    it('handles ENOENT errors gracefully when file does not exist', () => {
      const configObject = new ConfigFile(config).read();
